...
No campo do direito, a aplicação destas técnicas vêm sendo testadas em diversos âmbitos. No Supremo Tribunal Federal do Brasil, por exemplo, já existem tecnologias que utilizam destas técnicas para auxiliar o fluxo de trabalho.
...
::: incremental
- Para a construção deste agregador, primeiramente utilizar-se-á técnicas de vetorização de texto.
...
- O algoritmos de vetorização foi fornecido pela STI do STF, com implementação em *Python*, versão 3.8, utilizando o módulo `Doc2Vec` da biblioteca `gensim`.
...
<table border="1" style="border-collapse: collapse; width: 100%;">
    <caption>Tabela 2: Cronograma TCC 2</caption>
    <thead>
        <tr>
            <th>Atividades</th>
            <th>Ago</th>
    ...
    <tbody>
        ...
        <tr>
            <td>Entrega do relatório final ao Professora Orientadora.</td>
            <td></td>
            <td></td>
            <td></td>
            <td style="background-color:gray;"></td>
...
- JOHNSON, R. A.; WICHERN, D. W. Applied Multivariate Statistical Analysis. [S.l.]:
6. ed.[S.l.]:Prentice Hall, 2007.
