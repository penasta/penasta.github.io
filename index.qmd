...
::: incremental
- No campo do direito, a aplicação de técnicas estatísticas vêm sendo testada em diversos âmbitos, inclusive no Supremo Tribunal Federal do Brasil
...
::: {.column width="30%"}
![](fig3.png){.relative top="250" left="10" width="500" height="280"}
:::
